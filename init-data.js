...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!localStorage.getItem('courseVideos')) {
        const sampleVideos = [
            ...
            {
                id: 'v2',
                title: 'Science Experiments for Class 1',
                description: 'Simple science experiments that can be done at home',
                subject: 'science',
                targetClass: '1',
                section: 'A',
                duration: '25',
                tags: ['experiments', 'hands-on', 'fun'],
                uploadDate: new Date().toISOString(),
                thumbnail: 'https://via.placeholder.com/320x180?text=Science+Video'
            },
            {
                id: 'v3',
