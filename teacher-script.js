document.addEventListener('DOMContentLoaded', function() {
    ...
    if (teacher) {
        ...
        document.getElementById('profileClasses').textContent = teacher.classes.map(cls => `Class ${cls}`).join(', ');
...
function populateAssessmentFilters() {
    ...
    ['assessmentClass', 'viewClass'].forEach(id => {
    ...
    ['assessmentSection', 'viewSection'].forEach(id => {
...
function resetAttendanceForm() {
    ...
    document.getElementById('noStudentsMessage').style.display = 'block';
    document.getElementById('noStudentsMessage').textContent = 'Please select class and section to load students';
